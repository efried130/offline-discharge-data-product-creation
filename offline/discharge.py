...
def compute(reach, reach_height, reach_width, reach_slope, reach_d_x_area,
            height_u, width_u, slope_u, d_x_area_u):
    ...
    for key, models in reach['discharge_models'].items():
        ...
        if (reach_width > 0 and reach_slope > 0 and metro_Abar+d_x_area >= 0 and
            ...
            metro_width_u = ((metro_p - (2/3)) / reach_width) * width_u
            metro_d_x_area_u = ((5/3) - metro_p) / (metro_Abar + d_x_area) * \
                               d_x_area_u
            # metroman opt 5 uncertainties
            ...
            metro_r_u = np.sqrt(metro_width_u**2 + metro_d_x_area_u**2 +
                                metro_slp_u**2)
        ...
        if (reach_width > 0 and reach_slope > 0 and hivdi_Abar+d_x_area >= 0 and
            ...
            hivdi_d_x_area_u = d_x_area_u * (5/3 + hivdi_beta) / \
                               (hivdi_Abar + d_x_area)
